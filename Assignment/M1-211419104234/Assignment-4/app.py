...
def registerPage():
    if request.method == "POST":
        ...
        try:
            ...
            if role == "seeker":
                sql = "INSERT INTO SEEKER VALUES('{}','{}','{}','{}','{}','{}')".format(request.form["uemail"],
                                                                                        request.form["upass"],
                                                                                        request.form["uname"],
                                                                                        request.form["umobileno"],
                                                                                        request.form["uworkstatus"],
                                                                                        request.form["uorganisation"])
            else:
                sql = "INSERT INTO RECRUITER VALUES('{}','{}','{}','{}','{}')".format(request.form["uemail"],
                                                                                      request.form["upass"],
                                                                                      request.form["uname"],
                                                                                      request.form["umobileno"],
                                                                                      request.form["uorganisation"])
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if dictionary != False:
                ...
                fields = ['JOBID', 'COMPANY', 'RECRUITER MAIL', 'ROLE', 'DOMAIN', 'JOB TYPE', 'JOB DESCRIPTION',
                          'EDUCATION', 'KEY SKILLS', 'EXPERIENCE', 'LOCATION', 'SALARY', 'BENEFITS AND PERKS',
                          'APPLICATION DEADLINE', 'LOGO', 'NUMBER OF VACANCIES', 'POSTED DATE']
                today = date.today()
        ...
        try:
            ...
            if uploaded_file.filename != '':
                ...
                try:
                    ...
                    sql2 = "UPDATE JOBS SET NUMBEROFVACANCIES = NUMBEROFVACANCIES-1 WHERE JOBID='{}'".format(
                        request.form["jobidname"])
